...
class VoiceService:
    ...
    async def generate_audio_from_text(self, audio: UploadFile, text: str):
        ...
        for speaker_key in speaker_ids.keys():
            ...
            self.model.tts_to_file(text, speaker_id, src_path, speed=1)
            save_path = f'{self.output_dir}/output_v2_{speaker_key}_{uuid.uuid4()}.wav'
        ...
        return FileResponse(path=save_path, filename='speech.wav', media_type="audio/mpeg")
