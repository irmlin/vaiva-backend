...
import torch
from src.external.sadtalker.src.facerender.modules.util import Hourglass, make_coordinate_grid, kp2gaussian

from src.external.sadtalker.src.facerender.sync_batchnorm import SynchronizedBatchNorm3d as BatchNorm3d
